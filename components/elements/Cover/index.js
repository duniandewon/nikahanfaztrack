...
export default function Cover(props) {
	...
	return (
		<Wrapper>
			<div className={isSealOpen ? styles.coverRightOut : styles.coverRight} onClick={_handleOpenSeal}>
				<Image src={CoverRight} alt="Cover right" />
			</div>

			<div className={isSealOpen ? styles.coverLeftOut : styles.coverLeft} onClick={_handleOpenSeal}>
				<Image src={Coverleft} alt="Cover left" />
			</div>

			<div className={isSealOpen ? styles.sealOut : styles.seal} onClick={_handleOpenSeal}>
